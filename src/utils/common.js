...
export const reportLog = (message: string, extra?: Object, level: SeverityLevel = Severity.Info) => {
...
export const reportErrorLog = (message: string, extra?: Object) => {
  reportLog(message, extra, Severity.Error);
};

export const logBreadcrumb = (category: string, message: string, extra: any, level: SeverityLevel = Severity.Info) => {
  if (__DEV__) {
...
export const reportOrWarn = (message: string, extra?: Object, level: SeverityLevel = Severity.Info) => {
  if (__DEV__) {
